    ...
    <section className="relative pt-36 pb-24 overflow-hidden min-h-screen flex items-center">
      <div className="container mx-auto px-6 grid lg:grid-cols-2 gap-16 items-center">
        ...
        <div className="z-20 relative">
            <h1 className="font-display text-6xl lg:text-8xl font-medium leading-[1.05] mb-10 text-white">
        ...
        <div className="relative z-10 flex justify-center lg:justify-end mt-16 lg:mt-0 perspective-1000">
          ...
          <div className="relative w-full max-w-2xl">
             ...
             <svg className="absolute -left-24 -top-24 w-[150%] h-[150%] z-0 pointer-events-none overflow-visible">
             ...
             <MotionDiv 
                className="absolute -left-20 bottom-24 z-30"
                initial={{ opacity: 0, x: 20 }}
                animate={{ opacity: 1, x: 0 }}
             ...
             >
                 <div className="absolute inset-0 bg-[#0A0F0A] rounded-3xl border border-white/10 shadow-2xl overflow-hidden flex flex-col">
                    ...
                    <div className="flex-1 relative p-8 flex gap-8">
                        ...
                        <div className="w-1/2 bg-white/5 rounded-xl border border-white/5 p-6 relative overflow-hidden group">
